...
## Two New Formats and a Lot of Polish

A week after the first [0.0.1 release](/status/2026/20260723-release-0.0.1/), Sheetmusic4J 0.0.2 is out. The 0.0.1 release was really a question: is there interest in a native Java(FX) sheet music library? The early feedback said "keep going," so I did, and this release is the result. After sharing this library on LinkedIn, I immediately got the question if ABC Notation and Guitar Pro files could also be supported.

The first release could read MusicXML and MIDI. This one adds two more ways to get music into the library, and spends a lot of effort making what ends up on the staff look better.
