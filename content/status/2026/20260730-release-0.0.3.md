...
description: "A patch release wiring the .abc extension into the ScoreFile facade, so one-line load and save work for ABC files alongside MusicXML, MIDI and Guitar Pro."
---
